...
#define NODE_MAIN_LOGGER_NAME "gait_publisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmotion.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<Robot::MotionManager>";

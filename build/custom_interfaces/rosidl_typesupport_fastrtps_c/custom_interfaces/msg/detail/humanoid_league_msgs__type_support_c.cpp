...
#include "custom_interfaces/msg/detail/humanoid_league_msgs__rosidl_typesupport_fastrtps_c.h"
...
using _HumanoidLeagueMsgs__ros_msg_type = custom_interfaces__msg__HumanoidLeagueMsgs;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: team_mates_with_penalty
  {
    ...
    if (!rosidl_runtime_c__boolean__Sequence__init(&ros_message->team_mates_with_penalty, size)) {
      fprintf(stderr, "failed to create array for field 'team_mates_with_penalty'");
      return false;
    }
    auto array_ptr = ros_message->team_mates_with_penalty.data;
  ...
  // Field name: team_mates_with_red_card
  {
    ...
    if (!rosidl_runtime_c__boolean__Sequence__init(&ros_message->team_mates_with_red_card, size)) {
      fprintf(stderr, "failed to create array for field 'team_mates_with_red_card'");
      return false;
    }
    auto array_ptr = ros_message->team_mates_with_red_card.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_custom_interfaces__msg__HumanoidLeagueMsgs(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HumanoidLeagueMsgs__ros_msg_type * ros_message = static_cast<const _HumanoidLeagueMsgs__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _HumanoidLeagueMsgs__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__HumanoidLeagueMsgs(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__HumanoidLeagueMsgs(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__HumanoidLeagueMsgs;
    is_plain =
      (
      offsetof(DataType, team_mates_with_red_card) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _HumanoidLeagueMsgs__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_custom_interfaces__msg__HumanoidLeagueMsgs(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, HumanoidLeagueMsgs)() {

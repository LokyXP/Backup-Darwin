...
#include "custom_interfaces/msg/detail/walk__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::Walk & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::Walk & ros_message)
{
  // Member: walk_number
  cdr >> ros_message.walk_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::Walk;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::Walk *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::Walk *>(
    untyped_ros_message);
...
static size_t _Walk__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Walk(full_bounded, is_plain, 0);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Walk__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, Walk)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Walk__handle;
}

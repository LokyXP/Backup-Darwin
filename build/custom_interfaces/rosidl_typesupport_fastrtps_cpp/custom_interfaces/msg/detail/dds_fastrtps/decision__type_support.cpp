...
#include "custom_interfaces/msg/detail/decision__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::Decision & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::Decision & ros_message)
{
  // Member: decision
  cdr >> ros_message.decision;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::Decision;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::Decision *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::Decision *>(
    untyped_ros_message);
...
static size_t _Decision__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Decision(full_bounded, is_plain, 0);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Decision__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, Decision)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Decision__handle;
}

...
#include "custom_interfaces/msg/detail/joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::JointState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::JointState & ros_message)
{
  // Member: id
  {
    cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::JointState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::JointState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::JointState *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, JointState)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_JointState__handle;
}

...
#include "custom_interfaces/msg/detail/humanoid_league_msgs__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::HumanoidLeagueMsgs & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::HumanoidLeagueMsgs & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::HumanoidLeagueMsgs;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::HumanoidLeagueMsgs *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::HumanoidLeagueMsgs *>(
    untyped_ros_message);
...
static size_t _HumanoidLeagueMsgs__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HumanoidLeagueMsgs(full_bounded, is_plain, 0);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_HumanoidLeagueMsgs__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, HumanoidLeagueMsgs)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_HumanoidLeagueMsgs__handle;
}

  ...
  std::ostream & out)
{
  ...
  {
    out << "center_right: ";
    rosidl_generator_traits::value_to_yaml(msg.center_right, out);
    out << ", ";
  }
...
inline void to_yaml(
  const custom_interfaces::msg::Vision & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const custom_interfaces::msg::Vision & msg)
{

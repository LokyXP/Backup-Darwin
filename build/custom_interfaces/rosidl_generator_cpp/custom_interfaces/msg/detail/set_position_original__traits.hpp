...
inline std::string to_yaml(const SetPositionOriginal & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const custom_interfaces::msg::SetPositionOriginal & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const custom_interfaces::msg::SetPositionOriginal & msg)
{

...
bool
custom_interfaces__msg__Localization__are_equal(const custom_interfaces__msg__Localization * lhs, const custom_interfaces__msg__Localization * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
custom_interfaces__msg__Localization__copy(
  const custom_interfaces__msg__Localization * input,
  custom_interfaces__msg__Localization * output)
{
  if (!input || !output) {
    return false;
  }
...
custom_interfaces__msg__Localization__create()
{
  ...
  custom_interfaces__msg__Localization * msg = (custom_interfaces__msg__Localization *)allocator.allocate(sizeof(custom_interfaces__msg__Localization), allocator.state);
  if (!msg) {
    return NULL;
  }
...
custom_interfaces__msg__Localization__Sequence__init(custom_interfaces__msg__Localization__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (custom_interfaces__msg__Localization *)allocator.zero_allocate(size, sizeof(custom_interfaces__msg__Localization), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_interfaces__msg__Localization__Sequence * array = (custom_interfaces__msg__Localization__Sequence *)allocator.allocate(sizeof(custom_interfaces__msg__Localization__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
custom_interfaces__msg__Localization__Sequence__are_equal(const custom_interfaces__msg__Localization__Sequence * lhs, const custom_interfaces__msg__Localization__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_interfaces__msg__Localization__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
custom_interfaces__msg__Localization__Sequence__copy(
  const custom_interfaces__msg__Localization__Sequence * input,
  custom_interfaces__msg__Localization__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_interfaces__msg__Localization);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_interfaces__msg__Localization * data =
      (custom_interfaces__msg__Localization *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_interfaces__msg__Localization__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_interfaces__msg__Localization__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_interfaces__msg__Localization__copy(

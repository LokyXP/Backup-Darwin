...
custom_interfaces__msg__SetPositionOriginal__create()
{
  ...
  custom_interfaces__msg__SetPositionOriginal * msg = (custom_interfaces__msg__SetPositionOriginal *)allocator.allocate(sizeof(custom_interfaces__msg__SetPositionOriginal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
custom_interfaces__msg__SetPositionOriginal__Sequence__init(custom_interfaces__msg__SetPositionOriginal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (custom_interfaces__msg__SetPositionOriginal *)allocator.zero_allocate(size, sizeof(custom_interfaces__msg__SetPositionOriginal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_interfaces__msg__SetPositionOriginal__Sequence * array = (custom_interfaces__msg__SetPositionOriginal__Sequence *)allocator.allocate(sizeof(custom_interfaces__msg__SetPositionOriginal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
custom_interfaces__msg__SetPositionOriginal__Sequence__are_equal(const custom_interfaces__msg__SetPositionOriginal__Sequence * lhs, const custom_interfaces__msg__SetPositionOriginal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_interfaces__msg__SetPositionOriginal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_interfaces__msg__SetPositionOriginal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_interfaces__msg__SetPositionOriginal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_interfaces__msg__SetPositionOriginal * data =
      (custom_interfaces__msg__SetPositionOriginal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_interfaces__msg__SetPositionOriginal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_interfaces__msg__SetPositionOriginal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_interfaces__msg__SetPositionOriginal__copy(
